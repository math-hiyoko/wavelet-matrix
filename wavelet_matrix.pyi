...
class WaveletMatrix:
    def __init__(self, data: Iterable[int], on_disk: bool = False) -> None: ...
    def __getitem__(self, index: int) -> int: ...
    def __len__(self) -> int: ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __copy__(self) -> "WaveletMatrix": ...  # noqa: UP037
    def __deepcopy__(self, memo) -> "WaveletMatrix": ...  # noqa: UP037
...
class DynamicWaveletMatrix:
    ...
    def __str__(self) -> str: ...
    def __repr__(self) -> str: ...
    def __copy__(self) -> "DynamicWaveletMatrix": ...  # noqa: UP037
    def __deepcopy__(self, memo) -> "DynamicWaveletMatrix": ...  # noqa: UP037
    def values(self) -> list[int]: ...
    def access(self, index: int) -> int: ...
    def rank(self, value: int, end: int) -> int: ...
    def select(self, value: int, kth: int) -> int | None: ...
